...
begin
  ...
  IF CONTENIDO[x,y]=0 THEN begin
                           append(log);
                           energia:=energia;
                           close(log);
                           end

  ELSE IF CONTENIDO[x,y]=1 THEN begin
                           energia:=energia+2;
                           append(log);
                           writeln(log,'ENERGIA');
                           close(log);
  ...
  ELSE IF CONTENIDO[x,y]=2 THEN begin
                           MAREO:=MAREO+5;
                           append(log);
                           writeln(log,'MAREO:',MAREO);
                           close(log);
                           end

  ELSE IF CONTENIDO[x,y]=3 THEN if MAREO=0 then begin
                                             energia:=energia-3;
                                             append(log);
                                             writeln(log,'ORCO');
                                             close(log);
 ...
 X:=1;  Y:=1;
   ...
   WHILE ((energia>0) and ( MAREO=0)) DO
     begin

      append(log);

     IF DIRECCION[fil,col]=0 THEN  writeln(log,'[',x,',',y,'] - NORTE - ',energia)
     ELSE IF DIRECCION[fil,col]=1 THEN writeln(log,'[',x,',',y,'] -  SUR  - ',energia)
     ELSE IF DIRECCION[fil,col]=2 THEN writeln(log,'[',x,',',y,'] -  ESTE - ',energia)
     ELSE IF DIRECCION[fil,col]=3 THEN writeln(log,'[',x,',',y,'] - OESTE - ',energia);
 ...
 /////////////ESTADO DE FRODO MAREADO//////////////////
   ...
   WHILE ((MAREO>0) and (energia>0)) DO
     ...
     IF DIRECCION[fil,col]=0 THEN  writeln(log,'mareo: ',MAREO,'[',x,',',y,'] - NORTE - ',energia)
     ELSE IF DIRECCION[fil,col]=1 THEN writeln(log,'mareo: ',MAREO,'[',x,',',y,'] -  SUR  - ',energia)
     ELSE IF DIRECCION[fil,col]=2 THEN writeln(log,'mareo: ',MAREO,'[',x,',',y,'] -  ESTE - ',energia)
     ELSE IF DIRECCION[fil,col]=3 THEN writeln(log,'mareo: ',MAREO,'[',x,',',y,'] - OESTE - ',energia);
